...
answerFile=12_EV-news400-blip2
...
answerFile=12_EV-news400-instructBlip
...
answerFile=12_EV-news400-llava_15_7b
...
answerFile=12_EV-news400-llava_15_13b
questionFile=$1/_questions/questions_news400-2.jsonl
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=12_EV-news400-llava_16_7b
questionFile=$1/_questions/questions_news400-2.jsonl
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
