...
do
    ...
    questionFile=$1/_questions/questions_news400-$newCounter.jsonl
    answerFile=11_DV-news400-blip2$counter
    ...
    questionFile=$1/_questions/questions_news400-$newCounter.jsonl
    answerFile=11_DV-news400-instructBlip$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=11_DV-news400-llava_15_7b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=11_DV-news400-llava_15_13b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=11_DV-news400-llava_16_7b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
