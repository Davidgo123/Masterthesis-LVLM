...
for prompt in "${prompts[@]}"; do
    ...
    answerFile=212_EV_1xN-news400-blip2$counter
    ...
    answerFile=212_EV_1xN-news400-instructBlip$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=212_EV_1xN-news400-llava_15_7b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=212_EV_1xN-news400-llava_15_13b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
    ...
    answerFile=212_EV_1xN-news400-llava_16_7b$counter
    activeModels+=(${answerFile})
    if [ $3 -eq 1 ]
    then
