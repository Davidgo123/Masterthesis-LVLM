...
answerFile=211_EV_1x1-tamperednews-blip2
...
answerFile=211_EV_1x1-tamperednews-instructBlip
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=211_EV_1x1-tamperednews-llava_15_7b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=211_EV_1x1-tamperednews-llava_15_13b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=211_EV_1x1-tamperednews-llava_16_7b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
    python ./model_scripts/llava.py --question-file $questionFile --answer-file-path $answerFilePath --model-path $modelPath --answer-file-name $answerFile &
