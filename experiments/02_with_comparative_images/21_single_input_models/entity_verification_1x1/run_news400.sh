...
answerFile=02_21_EV_1x1-news400-blip2
...
answerFile=02_21_EV_1x1-news400-instructBlip
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=02_21_EV_1x1-news400-llava_15_7b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=02_21_EV_1x1-news400-llava_15_13b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
...
answerFile=02_21_EV_1x1-news400-llava_16_7b
activeModels+=(${answerFile})
if [ $3 -eq 1 ]
then
    python ./model_scripts/llava.py --question-file $questionFile --answer-file-path $answerFilePath --model-path $modelPath --answer-file-name $answerFile &
