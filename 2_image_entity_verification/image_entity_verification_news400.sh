...
questionFile=/nfs/home/ernstd/masterthesis_scripts/2_image_entity_verification/_questions/questions_news400.jsonl
answerFilePath=/nfs/home/ernstd/masterthesis_scripts/2_image_entity_verification/model_answers/news400/

# - - - - - - - - - -

if [ $1 -eq 1 ]
then
    python /nfs/home/ernstd/masterthesis_scripts/2_image_entity_verification/scripts/news400/prepare_questions.py --question-file $questionFile &
    PID=$!
    wait $PID
fi
...
python /nfs/home/ernstd/masterthesis_scripts/2_image_entity_verification/scripts/news400/analyze_answers.py --models ${activeModels[@]} &
PID=$!
wait $PID

python /nfs/home/ernstd/masterthesis_scripts/2_image_entity_verification/scripts/news400/printResultTable.py --models ${activeModels[@]} &
PID=$!
wait $PID