...
# # # # # # # # # # # # # # # # # # # # # 
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/21-EV-1x1-News400.out ${basePath[2]}/run_news400.sh ${basePath[2]} $createQuestions $runModels
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/21-EV-1x1-Tamperednews.out ${basePath[2]}/run_tamperednews.sh ${basePath[2]} $createQuestions $runModels
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/21-EV-1xN-Tamperednews.out ${basePath[3]}/run_tamperednews.sh ${basePath[3]} $createQuestions $runModels
...
# # # # # # # # # # # # # # # # # # # # #
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/22-EV-1x1-News400.out ${basePath[4]}/run_news400.sh ${basePath[4]} $createQuestions $runModels
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/22-EV-1x1-Tamperednews.out ${basePath[4]}/run_tamperednews.sh ${basePath[4]} $createQuestions $runModels
# sbatch -w devbox5 -c 12 --mem 32G --gres=gpu:a3090:1 --output=./output/logs/22-EV-1xN-Tamperednews.out ${basePath[5]}/run_tamperednews.sh ${basePath[5]} $createQuestions $runModels
