...
questionFile=/nfs/home/ernstd/masterthesis_scripts/3_max_image_entity_verification/_questions/questions_tamperedNews.jsonl
answerFilePath=/nfs/home/ernstd/masterthesis_scripts/3_max_image_entity_verification/model_answers/tamperedNews/

# - - - - - - - - - -

if [ $1 -eq 1 ]
then
    python /nfs/home/ernstd/masterthesis_scripts/3_max_image_entity_verification/scripts/tamperedNews/prepare_questions.py --question-file $questionFile &
    PID=$!
    wait $PID
fi
...
python /nfs/home/ernstd/masterthesis_scripts/3_max_image_entity_verification/scripts/tamperedNews/analyze_answers.py --models ${activeModels[@]} &
PID=$!
wait $PID

python /nfs/home/ernstd/masterthesis_scripts/3_max_image_entity_verification/scripts/tamperedNews/printResultTable.py --models ${activeModels[@]} &
PID=$!
wait $PID