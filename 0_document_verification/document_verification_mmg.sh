...
questionFile=/nfs/home/ernstd/masterthesis_scripts/0_document_verification/_questions/questions_mmg.jsonl
answerFilePath=/nfs/home/ernstd/masterthesis_scripts/0_document_verification/model_answers/mmg/

# - - - - - - - - - -

# python /nfs/home/ernstd/masterthesis_scripts/0_document_verification/scripts/mmg/prepare_questions.py --question-file $questionFile &
# pid1=$!
# wait $pid1
