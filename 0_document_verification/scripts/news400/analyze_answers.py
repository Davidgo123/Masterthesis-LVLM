...
def computeAnswer(args):
    ...
    for modelname in args.models:
        ...
        with open(f"/nfs/home/ernstd/masterthesis_scripts/0_document_verification/model_answers/news400/{modelname}.jsonl", 'r') as file:
            for line in file:
            ...
            for testlabel in groupedModelAnswers[entityType]:
                for questionID in groupedModelAnswers[entityType][testlabel]:
                    ...
                    for question in groupedModelAnswers[entityType][testlabel][questionID]:
                        if (question['set'] == 'text') and (question['text'] == 'yes'):
                            oneVisibleText = True
                        if (question['set'] == 'test') and (question['text'] == 'yes'):
                            oneVisibleTest = True
                    ...
                    for question in groupedModelAnswers[entityType][testlabel][questionID]:
                        ...
                        if question['set'] == 'text':
                            if question['text'] == 'yes':
                                scoreText.append(float(question['textPB']))
                            elif question['text'] == 'no':
        ...
        answerFile = open(f"/nfs/home/ernstd/masterthesis_scripts/0_document_verification/model_answers/news400/evaluation/{modelname}.csv", 'w', newline ='')
        with answerFile:
