...
questionFile=/nfs/home/ernstd/masterthesis_scripts/2_entity_verification_ib/_questions/questions_news400.jsonl
answerFilePath=/nfs/home/ernstd/masterthesis_scripts/2_entity_verification_ib/model_answers/news400/

# - - - - - - - - - -

python /nfs/home/ernstd/masterthesis_scripts/2_entity_verification_ib/scripts/news400/prepare_questions.py --question-file $questionFile &
pid1=$!
wait $pid1
...
python /nfs/home/ernstd/masterthesis_scripts/2_entity_verification_ib/scripts/news400/analyze_answers.py --models ${activeModels[@]} &
pid7=$!
wait $pid7

python /nfs/home/ernstd/masterthesis_scripts/2_entity_verification_ib/scripts/news400/printResultTable.py --models ${activeModels[@]} &
pid8=$!
wait $pid8