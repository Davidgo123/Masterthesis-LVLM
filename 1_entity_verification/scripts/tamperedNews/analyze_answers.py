...
def computeAnswer(args):
    ...
    for modelname in args.models:
        ...
        with open(f"/nfs/home/ernstd/masterthesis_scripts/1_entity_verification/model_answers/tamperedNews/{modelname}.jsonl", 'r') as file:
            for line in file:
        ...
        answerFile = open(f"/nfs/home/ernstd/masterthesis_scripts/1_entity_verification/model_answers/tamperedNews/evaluation/{modelname}.csv", 'w', newline ='')
        with answerFile:
