...
questionFile=/nfs/home/ernstd/masterthesis_scripts/1_entity_verification/_questions/questions_tamperedNews.jsonl
answerFilePath=/nfs/home/ernstd/masterthesis_scripts/1_entity_verification/model_answers/tamperedNews/

# - - - - - - - - - -

python /nfs/home/ernstd/masterthesis_scripts/1_entity_verification/scripts/tamperedNews/prepare_questions.py --question-file $questionFile &
pid1=$!
wait $pid1
...
python /nfs/home/ernstd/masterthesis_scripts/1_entity_verification/scripts/tamperedNews/analyze_answers.py --models ${activeModels[@]} &
pid7=$!
wait $pid7

python /nfs/home/ernstd/masterthesis_scripts/1_entity_verification/scripts/tamperedNews/printResultTable.py --models ${activeModels[@]} &
pid8=$!
wait $pid8