...
def run_analyze(args):
    ...
    for modelname in args.models:
        ...
        for questionType in modelAnswers:
            ...
            answerFile = open(f"/nfs/home/ernstd/data/news400/document_verification/answers_{questionType}.csv", 'w', newline ='')
            with answerFile:
                ...
                for key, values in itertools.groupby(modelAnswers[questionType], lambda x: x["question_id"]):
                    ...
                    for answer in list(values):
                        ...
                        # check if model answer is undefinied 
                            ...
                            print(answer['wrong_label'])
                            print(simplifyAnswer(answer['TR']))
                            print()
